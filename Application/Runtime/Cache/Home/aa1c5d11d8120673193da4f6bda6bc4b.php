...
<nav>
    <div class="comm">
        ...
        <a class="index" href="<?php echo U('Order/travel');?>">
            在线订车
        </a>
...
<div class="comm uc">
    <div class="left">
        ...
        <ul>
            <li>
                <a href="<?php echo U('Order/order_list?type=0');?>" id="myorder">
                    竞价订单
                </a>
            </li>
            <li>
                <a href="<?php echo U('Order/order_list?type=1');?>" id="dayRentOrder">
                    日租订单
                </a>
            </li>
            <li>
                <a href="<?php echo U('Order/order_list?type=2');?>" id="transferOrder">
                    接送机订单
                </a>
            </li>
        </ul>
    ...
    <div class="right">
        <div class="query">
            ...
            method="post"> -->
            <form action="<?php echo U('Order/order_list?type=0');?>" id="searchForm" method="get">
                <dl>
                    <dt>
                        预定时间：
                    </dt>
            ...
            <div class="ostate">
                <dl>
                    <dd name="<?php if($status == 1): ?>0<?php endif; ?>">
                        <a href="<?php echo U('Order/order_list?type=0&status=1');?>">
                            待报价
                        </a>
                    </dd>
                    <dd name='<?php if($status == 2): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=2');?>">
                            已报价
                        </a>
                    </dd>
                    <dd name='<?php if($status == 3): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=3');?>">
                            已付款
                        </a>
                    </dd>
                    <dd name='<?php if($status == 4): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=4');?>">
                            已确认
                        </a>
                    </dd>
                    <dd name='<?php if($status == 5): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=5');?>">
                            已派车
                        </a>
                    </dd>
                    <dd name='<?php if($status == 6): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=6');?>">
                            已完成
                        </a>
                    </dd>
                    <dd name='<?php if($status == 7): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0&status=7');?>">
                            已取消
                        </a>
                    </dd>
                    <dd name='<?php if($status == ''): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=0');?>">
                            全部
                        </a>
                    </dd>
                </dl>
                    ...
                    <li class="vo">
                        <dl>
                            <?php if(is_array($order_list)): foreach($order_list as $key=>$list): ?><dd class="orderno">
                                    <a class="aLink" href="<?php echo U('Order/order_detail',array('id'=>$list['id'],'type'=>0));?>">
                                ...
                                <dd>
                                    <?php if($list["rental_type"] == 0): ?>单程
                                    <?php else: ?>
                                        往返<?php endif; ?>
                                </dd>
                                <dd>
                                    <?php echo ($list["travel_username"]); ?>
                                </dd>
                                <dd>
