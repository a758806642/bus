...
<nav>
    <div class="comm">
        ...
        <a class="index" href="<?php echo U('Order/rent_order');?>">
            日租包车
        </a>
        <a class="" href="<?php echo U('Order/shuttle_order');?>">
            接机/送机
        </a>
    </div>
</nav>
...
<div class="comm uc">
    <div class="left">
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo U('Order/order_list?type=1');?>" id="myorder">
                    日租订单
                </a>
            </li>
            <li>
                <a href="<?php echo U('Order/order_list?type=2');?>" id="">
                    接送机订单
                </a>
            </li>
        </ul>
    ...
    <div class="right">
        <div class="query">
            ...
            method="post"> -->
            <form action="<?php echo U('Order/order_list?type=1');?>" id="searchForm" method="get">
                <dl>
                    <dt>
                        预定时间：
                    </dt>
            ...
            <div class="ostate">
                <dl>
                    <dd name="<?php if($status == 1): ?>0<?php endif; ?>">
                        <a href="<?php echo U('Order/order_list?type=1&status=1');?>">
                            待报价
                        </a>
                    </dd>
                    <dd name='<?php if($status == 2): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1&status=2');?>">
                            已报价
                        </a>
                    </dd>
                    <dd name='<?php if($status == 3): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1&status=3');?>">
                            已付款
                        </a>
                    </dd>
                    <dd name='<?php if($status == 4): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1&status=4');?>">
                            已确认
                        </a>
                    </dd>
                    <dd name='<?php if($status == 5): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1&status=5');?>">
                            已派车
                        </a>
                    </dd>
                    <dd name='<?php if($status == 6): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1&status=6');?>">
                            已完成
                        </a>
                    </dd>
                    <dd name='<?php if($status == 6): ?>0<?php endif; ?>'>
                    ...
                    <dd name='<?php if($status == ''): ?>0<?php endif; ?>'>
                        <a href="<?php echo U('Order/order_list?type=1');?>">
                            全部
                        </a>
                    </dd>
                </dl>
                    ...
                    <li class="vo">
                        <dl>
                            <?php if(is_array($order_list)): foreach($order_list as $key=>$list): ?><dd class="orderno">
                                    <a class="aLink" href="<?php echo U('Order/order_detail',array('id'=>$list['id'],'type'=>1));?>">
                                        <?php echo ($list["order_num"]); ?>
                                    </a>
                                </dd>
                                <dd class="time">
                                    <?php echo (date("Y-m-d H:i",$list["create_time"])); ?>
                                </dd>
                                <dd class="time">
                                    <?php echo (date("Y-m-d H:i",$list["transport_time"])); ?>
                                </dd>
                                <dd>
                                    <?php echo ($list["travel_start"]); ?>
                                </dd>
                                <dd>
                                    <?php echo ($list["car_name"]); ?>
                                </dd>
                                <dd>
                                    <?php if($list["days"] == 999): ?>半天
                                        <?php elseif($list["days"] == 1): ?>一天
                                        <?php elseif($list["days"] == 2): ?>两天
                                        <?php elseif($list["days"] == 3): ?>三天
                                        <?php elseif($list["days"] == 4): ?>四天
                                        <?php elseif($list["days"] == 5): ?>五天<?php endif; ?>
                                </dd>
                                <dd class="opera">
                                        <span style="color:#009100">
                                            ...
                                            <?php elseif($list["order_status"] == 7): ?>
                                                已取消
                                            <?php elseif($list["order_status"] == 8): ?>
                                                待付款<?php endif; ?>
                                        </span>
