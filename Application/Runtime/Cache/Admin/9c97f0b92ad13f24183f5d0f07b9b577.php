...
<script src="/Application/Home/js/layer/layer.js"></script>
        ...
        <div class="main-wrap">
                <div class="crumb-wrap">
                    <div class="crumb-list"><i class="icon-font"></i><a href='<?php echo U("Index/admin_index");?>'>首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">接送机/火车订单列表</span></div>
                </div>
                ...
                <style>
                    ...
                    <div class="query">
                        <form action="<?php echo U('Order/order_list',array('type'=>1));?>" method="get" id="myform" name="myform" enctype="multipart/form-data">
                            <div class="search">
                                    <span>订单状态：</span>
                        ...
                        <div class="result-content">
                            <table class="result-tab" width="100%" style="text-align:center;">
                                ...
                                <?php if(is_array($order_list)): foreach($order_list as $key=>$list): ?><tr>
                                        <td><a href="<?php echo U('Order/order_detail',array('order_id'=>$list['id'],'type'=>2));?>"><?php echo ($list["order_num"]); ?></a></td>
                                        <td><?php echo (date("Y-m-d H:i",$list["create_time"])); ?></td>
                                        <td><?php echo (date("Y-m-d H:i",$list["transport_time"])); ?></td>
                                        <td><?php echo ($list["travel_start"]); ?></td>
                                        <td><?php echo ($list["car_name"]); ?></td>
                                        <td><?php if($list["service_type"] == 1): ?>接机
                                            <?php elseif($list["service_type"] == 2): ?>送机
                                            <?php elseif($list["service_type"] == 3): ?>接火车
                                            <?php elseif($list["service_type"] == 4): ?>送火车<?php endif; ?></td>
                                        <td>
