                            ...
                            <div class="search">
                                    <span>订单状态：</span>
                                        <select name="status" class="common-text" style="width:120px;">
                                            ...
                                            <option value="8" <?php if($status == 8): ?>selected<?php endif; ?>>
                                                待付款
                                            </option>
                        ...
                        <div class="result-content">
                            <table class="result-tab" width="100%" style="text-align:center;">
                                ...
                                <?php if(is_array($order_list)): foreach($order_list as $key=>$list): ?><tr>
                                        <td><a href="<?php echo U('Order/order_detail',array('order_id'=>$list['id'],'type'=>1));?>"><?php echo ($list["order_num"]); ?></a></td>
